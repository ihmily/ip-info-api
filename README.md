...
| API | 状态 | 平均响应 | 成功率 | 详情 |
|-----|------|---------|--------|------|
| baidu.opendata | ✅ | 721.97ms | 3/3 | [📁 查看](output/by_api/baidu.opendata/) |
| db-ip.com | ✅ | 60.58ms | 3/3 | [📁 查看](output/by_api/db-ip.com/) |
| demo.ip-api.com | ✅ | 22.17ms | 3/3 | [📁 查看](output/by_api/demo.ip-api.com/) |
| freeipapi.com | ✅ | 397.67ms | 3/3 | [📁 查看](output/by_api/freeipapi.com/) |
| geojs.io | ✅ | 89.24ms | 3/3 | [📁 查看](output/by_api/geojs.io/) |
| ip-api.com | ✅ | 11.87ms | 3/3 | [📁 查看](output/by_api/ip-api.com/) |
| ip.nc.gy | ✅ | 128.15ms | 3/3 | [📁 查看](output/by_api/ip.nc.gy/) |
| ip.sb | ✅ | 98.17ms | 3/3 | [📁 查看](output/by_api/ip.sb/) |
| ip2location.io | ✅ | 83.59ms | 3/3 | [📁 查看](output/by_api/ip2location.io/) |
| ipapi.co | ✅ | 110.72ms | 3/3 | [📁 查看](output/by_api/ipapi.co/) |
| ipapi.is | ✅ | 12.0ms | 3/3 | [📁 查看](output/by_api/ipapi.is/) |
| ipwhois.app | ✅ | 57.57ms | 3/3 | [📁 查看](output/by_api/ipwhois.app/) |
| pconline | ✅ | 2199.6ms | 3/3 | [📁 查看](output/by_api/pconline/) |
| realip.cc | ✅ | 196.76ms | 3/3 | [📁 查看](output/by_api/realip.cc/) |

### 仅查询本机IP的API

| API | 状态 | 平均响应 | 成功率 | 详情 |
|-----|------|---------|--------|------|
| api.ipify.org | ✅ | 80.84ms | 3/3 | [📁 查看](output/by_api/api.ipify.org/) |
| api.myip.com | ✅ | 171.01ms | 3/3 | [📁 查看](output/by_api/api.myip.com/) |
| bilibili | ❌ | - | 0/3 | [📁 查看](output/by_api/bilibili/) |
| cdid.ctrip | ✅ | 723.62ms | 3/3 | [📁 查看](output/by_api/cdid.ctrip/) |
| cip.cc | ✅ | 621.97ms | 3/3 | [📁 查看](output/by_api/cip.cc/) |
| cloudflare.trace | ✅ | 8.44ms | 3/3 | [📁 查看](output/by_api/cloudflare.trace/) |
| g3.letv | ✅ | 728.88ms | 3/3 | [📁 查看](output/by_api/g3.letv/) |
| gdt.qq | ✅ | 862.83ms | 3/3 | [📁 查看](output/by_api/gdt.qq/) |
| geolocation-db.com | ✅ | 415.17ms | 3/3 | [📁 查看](output/by_api/geolocation-db.com/) |
| httpbin.org | ✅ | 35.64ms | 3/3 | [📁 查看](output/by_api/httpbin.org/) |
| ifconfig.me | ✅ | 151.91ms | 3/3 | [📁 查看](output/by_api/ifconfig.me/) |
| ipbase.com | ✅ | 301.76ms | 3/3 | [📁 查看](output/by_api/ipbase.com/) |
| ipquery.io | ✅ | 231.47ms | 3/3 | [📁 查看](output/by_api/ipquery.io/) |
| my.ipinfo.app | ❌ | - | 0/3 | [📁 查看](output/by_api/my.ipinfo.app/) |
| myip.ipip.net | ✅ | 379.48ms | 3/3 | [📁 查看](output/by_api/myip.ipip.net/) |
| news.qq | ✅ | 525.6ms | 3/3 | [📁 查看](output/by_api/news.qq/) |
| qq.inews | ✅ | 537.48ms | 3/3 | [📁 查看](output/by_api/qq.inews/) |
| qq.video | ✅ | 419.35ms | 3/3 | [📁 查看](output/by_api/qq.video/) |
| test.ipw.cn | ❌ | - | 0/3 | [📁 查看](output/by_api/test.ipw.cn/) |
| torproject | ✅ | 414.85ms | 3/3 | [📁 查看](output/by_api/torproject/) |
| wtfismyip.com | ✅ | 346.81ms | 3/3 | [📁 查看](output/by_api/wtfismyip.com/) |

### 仅支持查询指定IP的API

| API | 状态 | 平均响应 | 成功率 | 详情 |
|-----|------|---------|--------|------|
| db-ip.demo | ✅ | 263.88ms | 3/3 | [📁 查看](output/by_api/db-ip.demo/) |
| ipinfo.io | ✅ | 253.85ms | 3/3 | [📁 查看](output/by_api/ipinfo.io/) |
| iqiyi.mesh | ✅ | 634.74ms | 3/3 | [📁 查看](output/by_api/iqiyi.mesh/) |
<!-- API_STATUS_END -->
